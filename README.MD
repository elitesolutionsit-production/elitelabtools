...
| Property                   | Required | Default | Description
    |
|----------------------------|----------|---------|--------------------------------------------------------|
AWS_ACCESS_KEY_ID            | True     |         | Expects a string value here, for aws access key id.

AWS_SECRET_ACCESS_KEY        | True     |         | Expects a string value here, for aws secret access key.
